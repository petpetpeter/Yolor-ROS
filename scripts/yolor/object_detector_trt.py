...
class YOLOR(object):
    def __init__(self, 
            ...
            #model_weights = 'engine/yolor_p6_fp16.trt', 
            max_size = 1280, 
        ...
        # Load model
        self.model = TrtModel(model_weights, max_size,total_classes = 1)
...
if __name__ == '__main__':
    model = YOLOR()
    img = cv2.imread('inference/images/multomato.jpg')
    detected_image = model.detect(img)
